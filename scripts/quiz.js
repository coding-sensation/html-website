d3.json("../json/quiz.json").then(function (quizzes) {
  ...
  for (let q = 0; q < quiz_chosen.questions.length; q++) {
    questions.push({
      ...
      answers: [
        {
          text: quiz_chosen.questions[q].answers.text_one,
          correct: JSON.parse(quiz_chosen.questions[q].results.correct_one),
        },
        {
          text: quiz_chosen.questions[q].answers.text_two,
          correct: JSON.parse(quiz_chosen.questions[q].results.correct_two),
        },
        {
          text: quiz_chosen.questions[q].answers.text_three,
          correct: JSON.parse(quiz_chosen.questions[q].results.correct_three),
        },
        {
          text: quiz_chosen.questions[q].answers.text_four,
          correct: JSON.parse(quiz_chosen.questions[q].results.correct_four),
        },
      ],
    });
  }
